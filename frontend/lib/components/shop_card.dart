...
class _ShopCardState extends State<ShopCard> {
  void _increaseCounter() async {
    await ApiService().increaseProductQuantity(widget.product.product.id);
    widget.onQuantityChanged(widget.quantity + 1);
  }

  void _decreaseCounter() async {
    if (widget.quantity > 1) {
      await ApiService().decreaseProductQuantity(widget.product.product.id);
      widget.onQuantityChanged(widget.quantity - 1);
    }
  }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    widget.product.product.shortDescription,
